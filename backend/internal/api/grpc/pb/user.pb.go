...
const file_api_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x14api/proto/user.proto\x12\x02pb\"Y\n" +
	...
	"\x05Login\x12\x10.pb.LoginRequest\x1a\x11.pb.LoginResponseB'Z%ecomerce-service/internal/api/grpc/pbb\x06proto3"
